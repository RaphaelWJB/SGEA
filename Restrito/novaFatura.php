...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <h1 class="mb-4">Cadastro de Fatura</h1>
                ...
                <form>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6 col-sm-6">
                            ...
                            <input type="text" class="form-control" id="empresadev" placeholder="Empresa Devedora">
                        </div>

                        <!--Data.Vencimento-->
                        <div class="form-group col-md-3 col-sm-6">
                            <label for="inputNomeFantasia">Data.Vencimento</label>
                            <input type="text" class="form-control" id="datavencimento" placeholder="Data.Vencimento">
                        </div>
